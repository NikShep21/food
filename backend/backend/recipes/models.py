...
class Recipe(models.Model):
    ...
    cooking_time = models.PositiveSmallIntegerField(
        ...
        validators=[
            ...
            MaxValueValidator(
                MAX_COOKING_TIME,
                message=f'Время должно быть не больше {MAX_COOKING_TIME}')
        ]
    )
...
class RecipeIngredient(models.Model):
    ...
    amount = models.PositiveSmallIntegerField(
        ...
        validators=[
            ...
            MaxValueValidator(
                MAX_COOKING_TIME,
                message=f'Количество должно быть не больше {MAX_COOKING_TIME}'
            )
        ]
    )
...
class UserRecipeRelationBase(models.Model):
    ...
    def __str__(self):
        ...
        return f'{model_name}: {self.user.username} - {self.recipe.name}'
